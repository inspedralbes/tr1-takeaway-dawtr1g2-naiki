    ...
    public function up(): void
    {
        ...
        DB::table('sabates')->insert([
            ...
            [
                ...
                'talles' => '28,29,30',
                'color' => 'Blanc',
                'imatge' => 'imatge/adidas-superstar-nen.jpg',
                'created_at' => DB::raw('NOW()'),
                'updated_at' => DB::raw('NOW()'),
            ],
            [
                ...
                'talles' => '28,29,30',
                'color' => 'Negre',
                'imatge' => 'imatge/nike-air-max-nen.jpg',
                'created_at' => DB::raw('NOW()'),
                'updated_at' => DB::raw('NOW()'),
            ],
            [
                ...
                'talles' => '25,26,27',
                'color' => 'Rosa',
                'imatge' => 'imatge/puma-cali-nen.jpg',
                'created_at' => DB::raw('NOW()'),
                'updated_at' => DB::raw('NOW()'),
            ],
            [
                ...
                'talles' => '25,26,27',
                'color' => 'Blanc',
                'imatge' => 'imatge/reebok-classic-nen.jpg',
                'created_at' => DB::raw('NOW()'),
                'updated_at' => DB::raw('NOW()'),
            ],
            [
                ...
                'talles' => '28,29,30',
                'color' => 'Blau',
                'imatge' => 'imatge/converse-chuck-nen.jpg',
                'created_at' => DB::raw('NOW()'),
                'updated_at' => DB::raw('NOW()'),
            ],
            [
                ...
                'talles' => '25,26,27',
                'color' => 'Negre',
                'imatge' => 'imatge/vans-old-skool-nen.jpg',
                'created_at' => DB::raw('NOW()'),
                'updated_at' => DB::raw('NOW()'),
            ],
            [
                ...
                'talles' => '28,29,30',
                'color' => 'Gris',
                'imatge' => 'imatge/new-balance-574-nen.jpg',
                'created_at' => DB::raw('NOW()'),
                'updated_at' => DB::raw('NOW()'),
            ],
            [
                ...
                'talles' => '25,26,27',
                'color' => 'Blanc',
                'imatge' => 'imatge/adidas-stan-smith-nen.jpg',
                'created_at' => DB::raw('NOW()'),
                'updated_at' => DB::raw('NOW()'),
            ],
            [
                ...
                'talles' => '28,29,30',
                'color' => 'Vermell',
                'imatge' => 'imatge/nike-blazer-nen.jpg',
                'created_at' => DB::raw('NOW()'),
                'updated_at' => DB::raw('NOW()'),
            ],
            [
                ...
                'talles' => '25,26,27',
                'color' => 'Negre',
                'imatge' => 'imatge/puma-suede-nen.jpg',
                'created_at' => DB::raw('NOW()'),
                'updated_at' => DB::raw('NOW()'),
            ],
        ]);
